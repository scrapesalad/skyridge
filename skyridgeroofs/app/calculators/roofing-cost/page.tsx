    ...
    <>
      ...
      <main className="min-h-screen bg-gray-50">
        ...
        <section className="container mx-auto px-4 py-12 max-w-4xl">
          ...
          {/* Roofing Materials Images */}
          <div className="mb-8">
            <h2 className="text-2xl font-bold mb-6 text-center">Roofing Material Options</h2>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              <div className="bg-white rounded-lg shadow-md overflow-hidden">
                <div className="relative h-48">
                  <Image
                    src="/images/skyridge/scrap/landmark-series-shingles-certainteed.jpg"
                    alt="Asphalt shingle roofing cost"
                    fill
                ...
                <div className="p-4">
                  ...
                  <p className="text-sm text-gray-600">Most affordable option, $3,000-$7,000 per square</p>
                </div>
              </div>
              <div className="bg-white rounded-lg shadow-md overflow-hidden">
                <div className="relative h-48">
                ...
                <div className="p-4">
                  ...
                  <p className="text-sm text-gray-600">Durable and energy-efficient, $7,000-$15,000 per square</p>
                </div>
              </div>
              <div className="bg-white rounded-lg shadow-md overflow-hidden">
                <div className="relative h-48">
                ...
                <div className="p-4">
                  ...
                  <p className="text-sm text-gray-600">TPO/EPDM for commercial, $5,000-$10,000 per square</p>
                </div>
              </div>
            </div>
          </div>
