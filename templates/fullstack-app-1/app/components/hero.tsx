...
export default function Hero({ className = '' }: HeroProps) {
  return (
    <div className={`relative w-full ${className}`}>
      {/* Hero Section - placement-friendly layout driven by generator tokens */}
      <section 
        className="relative h-[650px] md:h-[700px] flex items-center overflow-hidden bg-[#3B82F6]"
      >
        {/* Background Image */}
        <div className="absolute inset-0 z-0">
          <Image
            src="/images/Gemini_Generated_Image_poyl1bpoyl1bpoyl.png" 
        ...
        <div className="relative z-20 w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="relative max-w-2xl text-center md:text-left">
            ...
            <div className="relative p-6 md:p-8">
              {/* Main Headline - uses generator tokens for service + area */}
              <h1 
            ...
            >
              {{PRIMARY_SERVICE}} in {{SERVICE_AREA}}
            </h1>
            ...
            {/* Primary CTA Button - text driven by generator token */}
            <a
              href="/contact"
              data-analytics-type="cta"
