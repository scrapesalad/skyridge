...
export default function BulkEmailOutreach() {
  ...
  const emailTemplates = {
    ...
    'post-call-review': {
      ...
      content: "post_call_review_template"
    },
    custom: {
      subject: "",
      content: ""
  ...
  return (
    <div className="p-6 bg-white rounded-lg shadow-lg">
      ...
      {stats && (
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-8">
          <div className="bg-blue-50 p-4 rounded-lg">
            <h3 className="text-sm font-medium text-trust-blue-dark">Total Clients</h3>
          ...
          <div className="bg-gradient-to-br from-purple-50 to-purple-100 p-4 rounded-lg">
            ...
            <p className="text-2xl font-bold text-purple-900">{stats.clientsWithEmail}</p>
          </div>
          ...
          <div>
            ...
            <div className="mb-4">
              ...
              <input
                ...
                className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#0d9488] focus:border-transparent text-black"
          ...
          <div>
            ...
            <div className="space-y-4">
              ...
              <div className="p-4 bg-blue-50 rounded-lg">
                <h4 className="text-sm font-medium text-trust-blue-dark mb-2">
              ...
              <button
                ...
                className="w-full px-6 py-3 bg-[#0d9488] text-white rounded-lg hover:bg-teal-700 disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center"
              >
                {sending ? (
                  <>
              ...
              <div className="space-y-4">
                <div className="grid grid-cols-2 gap-4">
                  <div className="p-4 bg-gradient-to-br from-purple-50 to-purple-100 rounded-lg">
                    ...
                    <p className="text-2xl font-bold text-purple-900">{result.emailsSent}</p>
                  </div>
      ...
      <div className="mt-8 p-4 bg-blue-50 rounded-lg">
        <h4 className="text-sm font-medium text-trust-blue-dark mb-2">💡 Tips for Effective Email Outreach</h4>
