...
import VideoWithErrorHandling from '@/app/components/VideoWithErrorHandling';
...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: 'https://icondumpsters.com/pricing/dumpster-prices',
  ...
  alternates: { canonical: 'https://icondumpsters.com/pricing/dumpster-prices' }
};
